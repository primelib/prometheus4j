...
public class Rule {
    ...
    public enum HealthEnum {
        ...
        private static final HealthEnum[] VALUES = values(); // prevent allocating a new array for every call to values()
        private final String value;

        @JsonCreator
        public static HealthEnum of(String input) {
            if (input != null) {
                for (HealthEnum v : VALUES) {
