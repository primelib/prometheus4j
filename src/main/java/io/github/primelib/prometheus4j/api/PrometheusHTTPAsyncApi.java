...
public interface PrometheusHTTPAsyncApi {
    ...
    CompletableFuture<Void> cleanTombstones();
    ...
    CompletableFuture<SnapshotCreateResponse> createSnapshot(@Param("skip_head") @Nullable Boolean skipHead);
    ...
    CompletableFuture<Void> deleteSeries(@Param("match") @NotNull List<String> match, @Param("start") @Nullable String start, @Param("end") @Nullable String end);
     ...
     * @param timeout              Evaluation timeout. Optional. Defaults to and is capped by the value of the {@code }{@code -query.timeout}{@code } flag.  (optional)
     */
    @RequestLine("GET /query?query={query}&time={time}&timeout={timeout}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<QueryDataReadResponse> evaluateQueryInstant(@Param("query") @NotNull String query, @Param("time") @Nullable String time, @Param("timeout") @Nullable String timeout);
     ...
     * @param step                 Query resolution step width in {@code }{@code duration}{@code } format or float number of seconds.  (optional)
     * @param timeout              Evaluation timeout. Optional. Defaults to and is capped by the value of the {@code }{@code -query.timeout}{@code } flag.  (optional)
     */
    ...
    CompletableFuture<ResponseQueryRange> evaluateQueryRange(@Param("query") @NotNull String query, @Param("start") @Nullable String start, @Param("end") @Nullable String end, @Param("step") @Nullable String step, @Param("timeout") @Nullable String timeout);
    ...
    CompletableFuture<MetadataReadResponse> metricMetadataReadResponse(@Param("limit") @NotNull Integer limit, @Param("metric") @Nullable String metric);
    ...
    CompletableFuture<AlertManagerReadResponse> readAlertManagers();
    ...
    CompletableFuture<AlertReadResponse> readAlerts();
    ...
    CompletableFuture<LabelNamesReadResponse> readLabelNames(@Param("start") @Nullable String start, @Param("end") @Nullable String end, @Param("match") @Nullable List<String> match);
    ...
    CompletableFuture<LabelValuesReadResponse> readLabelValues(@Param("label_name") @NotNull String labelName, @Param("start") @NotNull String start, @Param("end") @Nullable String end, @Param("match") @Nullable List<String> match);
    ...
    CompletableFuture<QueryExemplarsReadResponse> readQueryExemplars(@Param("query") @NotNull String query, @Param("start") @Nullable String start, @Param("end") @Nullable String end);
     ...
     *
     * @param type                 Return only the alerting rules (e.g. {@code }{@code type=alert}{@code }) or the recording rules (e.g. {@code }{@code type=record}{@code }). When the parameter is absent or empty, no filtering is done.  (optional)
     */
    @RequestLine("GET /rules?type={type}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<RuleReadResponse> readRules(@Param("type") @Nullable String type);
     ...
     *
     * @param match                Repeated series selector argument that selects the series to return. At least one {@code }{@code match[]}{@code } argument must be provided.  (required)
    ...
    CompletableFuture<List<QueryDataResultMetric>> readSeries(@Param("match") @NotNull List<String> match, @Param("start") @Nullable String start, @Param("end") @Nullable String end);
    ...
    CompletableFuture<PrometheusBuildInfoReadResponse> readServerBuildInfo();
    ...
    CompletableFuture<PrometheusConfigReadResponse> readServerConfig();
    ...
    CompletableFuture<Void> readServerFlags();
    ...
    CompletableFuture<RuntimeInfoResponse> readServerRuntimeInfo();
    ...
    CompletableFuture<TsdbStatusReadResponse> readServerTSDBStatus();
    ...
    CompletableFuture<WalReplayStatusReadResponse> readServerWALReplayStatus();
    ...
    @ApiStatus.Experimental
    CompletableFuture<List<MetricMetadata>> readTargetMetadata(@Param("match_target") @Nullable String matchTarget, @Param("metric") @Nullable String metric, @Param("limit") @Nullable Integer limit);
     ...
     *
     * @param state                The {@code }{@code state}{@code } query parameter allows the caller to filter by active or dropped targets, (e.g., {@code }{@code state=active}{@code }, {@code }{@code state=dropped}{@code }, {@code }{@code state=any}{@code }).  (optional)
     */
    @RequestLine("GET /targets?state={state}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<TargetDiscoveryReadResponse> readTargets(@Param("state") @Nullable String state);
